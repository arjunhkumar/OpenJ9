...
std::vector<SPM_StaticProfileInfo *> SPM_StaticProfilingMetadata::getCallSiteProfile()
{
    return callSiteProfilingData;
}

U_32 SPM_StaticProfileInfo::getByteCodeIndex(SPM_StaticProfileInfo * profileInfo)
{
    return profileInfo->_bco;
}

std::vector<SPM_StaticProfileInfo *> SPM_StaticProfilingMetadata::getReturnSiteProfile()
{
    return returnSiteProfilingData;
}

std::vector<SPM_StaticProfileInfo *> SPM_StaticProfilingMetadata::getStaticAssignSiteProfile()
{
...
const char * SPM_StaticProfileInfo::createCopy(const char * targetString)
{
...
bool SPM_StaticProfilingMetadata::getCallSitePreference(char * methodSignature, uint32_t bci)
{
...
const char * SPM_StaticProfilingMetadata::getDebugCounterName(char * methodSignature, uint32_t bci)
{
    std::vector<SPM_StaticProfileInfo *> callSiteProfile = getCallSiteProfile();
    for (size_t i = 0; i < callSiteProfile.size(); ++i)
    {
...
void SPM_StaticProfilingMetadata::clearResults()
{
