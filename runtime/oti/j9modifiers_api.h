...
//inliningjclclasses: removing version check from J9ROMCLASS_IS_VALUE
...
//#define J9ROMCLASS_IS_VALUE(romClass)   (!_J9ROMCLASS_SUNMODIFIER_IS_ANY_SET((romClass), J9AccClassHasIdentity | J9AccInterface))
